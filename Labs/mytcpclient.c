...
int byte_received;
char buffer[1024];
bzero(buffer, 1024); //to make sure that the buffer is empty, buffer is just a space to store the message and 1024 is the size of it
